...
SENSOR_TYPE_ALIASES = {
    ...
    'contact': {'contact'},
    'navsat': {'navsat', 'gps'},
    'gpu_lidar': {'gpu_lidar', 'lidar', 'gpu_ray'},
...
def _is_sensor_type(sensor_type, canonical_name):
